...
describe UserSkillsController do
  describe "route generation" do
    ...
    it "maps #edit_inline" do
      route_for(:controller => "user_skills", :action => "edit_inline", :id => "1").should == "/user_skills/1/edit_inline"
    end
  ...
  describe "route recognition" do
    ...
    it "generates params for #edit_inline" do
      params_from(:get, "/user_skills/1/edit_inline").should == {:controller => "user_skills", :action => "edit_inline", :id => "1"}
    end  
