...
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "master_skills" text, "intermediate_skills" text, "newbie_skills" text, "remote_availability" varchar(255), "local_availability" varchar(255), "available_to_mentor" boolean, "available_to_be_mentored" boolean, "created_at" datetime, "updated_at" datetime, "identity_url" varchar(255), "email" varchar(255), "login" varchar(40), "crypted_password" varchar(40), "salt" varchar(40), "remember_token" varchar(40), "remember_token_expires_at" datetime);
...
INSERT INTO schema_migrations (version) VALUES ('20090611143741');